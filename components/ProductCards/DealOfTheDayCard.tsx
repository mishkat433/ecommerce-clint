    ...
    return (
        <div className="rounded-[10px] w-full  border border-[#D0D0D0] bg-white py-6 px-8 font-roboto container mx-auto">
            <div className="mb-2 flex items-center justify-between">
                <div>
                    <a href="#" className="rounded-[14px] bg-aide-primary py-[10px] px-6 text-base font-bold leading-5 text-white">HOT DEALS</a>
                </div>
                <div className="rounded-[5px] bg-aide-primary p-[10px] text-white w-10">
                    <AddToCartIcon />
                </div>
            </div>
            <div className="flex flex-col md:flex-row justify-between">
                <div className='flex flex-col justify-between'>
                    ...
                    <div className="text-xl font-normal leading-6 text-black">
                        ...
                        <div>
                            <h3 className="mb-[10px] text-xl font-normal leading-6 text-[#4A5568]">Sold: <span className="text-[#222222]">30 Items</span></h3>
