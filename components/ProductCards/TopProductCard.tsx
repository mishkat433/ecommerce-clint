...
const TopProductCard = () => {
    return (
        <div className="mb-[10px] flex justify-between gap-4 bg-white p-[9px] shadow cursor-pointer">
            <div>
                <Image className='w-[104px] h-[104px] object-cover' src={smallProduct} alt='Top Product' priority={true} />
            </div>
            <div>
