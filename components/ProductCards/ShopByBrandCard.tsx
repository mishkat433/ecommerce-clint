...
const ShopByBrandCard = ({ brand, fromCategory }: any) => {
    ...
    return (
        <div className="group relative bg-white rounded-lg shadow-small-card-shadow pt-[10px] text-center max-h-32 cursor-pointer">
            {
                !fromCategory &&
            ...
            {findFav?.id === _id ?
                <div className="w-[27px] duration-100 h-[27px] p-[5px] bg-white border-1 border-[#f0f0f0] shadow-fev-icon-box-shadow absolute right-1 bottom-5 rounded-full text-[#EDA464]">
                ...
                :
                <div className=" p-1 group-hover:scale-100 scale-0 duration-100 h-[27px] bg-white border-1 border-[#f0f0f0] shadow-fev-icon-box-shadow absolute right-1 bottom-5 rounded-full text-[#EDA464]">
