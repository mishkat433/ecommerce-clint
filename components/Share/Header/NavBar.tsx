// import { reset } from '@/Redux/AuthenticationSlice/AuthenticationSlice';
// import { statePassData } from '@/Redux/DatapassSlice/DataPassSlice';
// import { modalOpenClose } from '@/Redux/ModalSlice/ModalSlice';
// import { actimeMenu, sidebar2Control, sidebarControl } from '@/Redux/SideMenuControl/SideMenuControlSlice';
// import LocationIcon from '@/como/Icons/LocationIcon';
// import ProfileIcon from '@/como/Icons/ProfileIcon';
// import OnlineOffline from '@/como/OnlineOffline/OnlineOffline';
// import Image from 'next/image';
// import Link from 'next/link';
// import { useRouter } from 'next/router';
// import { useEffect, useState } from 'react';
// import { RiArrowDownSLine, RiMenuFoldLine, RiMenuUnfoldLine, RiMoonClearLine, RiNotification3Line, RiSearchLine, RiSunLine, RiUpload2Line } from 'react-icons/ri';
// import { toast } from 'react-toastify';
// import { useAppDispatch, useAppSelector } from '../../../Redux/app/hooks';
// import aideLogo from "../../../public/assets/aide-logo.png";
...
//     return (
//         <header className={`py-3 mb-4 font-inter bg-white duration-300 ${sideMenu && show ? 'w-full lg:w-[94%] duration-200' : 'w-full'} ${show ? "fixed z-10 top-10 md:top-9 left-auto py-3 bg-slate-50 duration-300" : ' duration-300 z-0'}`}>
//             <div className={`container mx-auto px-[15px] flex justify-between gap-2 items-center`}>
//                 {
//                     !sideMenu ?
//                         <div className=' cursor-pointer absolute top-50%  hover:text-aide-primary duration-300 ' onClick={() => dispatch(sidebarControl({ sideMenu: !sideMenu, sideMenu2: '' }))}>
//                             <RiMenuUnfoldLine className='text-2xl' />
//                         </div> :
//                         <div className=' cursor-pointer absolute top-50%  hover:text-aide-primary duration-300 ' onClick={() => {
//                             dispatch(sidebarControl(!sideMenu)); dispatch(sidebar2Control(""));
//                             dispatch(actimeMenu(""))
//                         }}>
...
//                         <Image priority={true} className='h-[36px] w-[34px]' src={aideLogo} alt="Aide-Logo" />
//                         <h1 className='text-[22px] text-aide-primary font-poppins font-semibold'>aide</h1>
//                     </Link>
//                 </div>
...
//                         <div className='text-[#00AF9E]'><LocationIcon /></div>

//                         <span className='text-[15px] font-medium text-secondary-text'> Current Location </span>
//                         <span className='text-[15px] font-medium text-aide-primary'>{address} </span>
//                         <div className='relative'>
//                             <RiArrowDownSLine className='navbarIconDesign' onClick={() => { dispatch(modalOpenClose('location')); dispatch(statePassData("tink ace")) }} />
//                         </div>
//                     </div>
//                 </div>
//                 <div className=''>
//                     <ul className='flex gap-3 md:gap-6 items-center relative'>
//                         <li className='navbarIconDesign' onClick={() => dispatch(modalOpenClose('searchModal'))}>
//                             <RiSearchLine className='' />
//                         </li>
//                         <li className='text-xl text-icon-color  cursor-pointer relative group'><RiNotification3Line className='hover:text-aide-primary duration-300' /><div className='h-2 w-2 bg-[#FF0000]  duration-300 rounded-full absolute top-[1px] right-[1px]'><span className='h-2 w-2 bg-[#FF0000] animate-ping duration-300 rounded-full absolute top-0 right-0'></span></div>
...
//                             </div>
//                         </li>
//                         <li className=' text-icon-color  cursor-pointer relative group hover:text-aide-primary duration-300' title='shopping bag' onClick={() => { dispatch(sidebarControl({ sideMenu: true, sideMenu2: 'cart' })); dispatch(actimeMenu('')) }}>
//                             <ShoppingBagIcon />
