...
const AfterSlide: NextPage = () => {
    ...
    return (
        <div className='after-slider bg-[#009788] flex flex-row items-center justify-center py-2 rounded ml-2'>
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="relative w-2/6 input-arrow-none">
                <input type="number" placeholder="Your Mobile number" className={`w-2/3 bg-gray-100 rounded-xl p-3 pr-12 ${errors.mobileNumber ? 'focus:outline-red-500' : 'focus:outline-teal-700'}`}
                ...
                <button type='submit' className="absolute top-1/2 -translate-y-1/2 right-[35%] text-xl bg-teal-600 p-2 text-white rounded-md cursor-pointer" > <FaArrowRight /> </button>
            </form>
        </div>
    )
}
